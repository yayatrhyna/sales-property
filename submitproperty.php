    ...
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
                    <div class="row">
						<div class="col-lg-12">
							<h2 class="text-secondary double-down-line text-center">Kirim Properti</h2>
                        </div>
					</div>
                    <div class="row p-5 bg-white">
                        <form method="post" enctype="multipart/form-data">
								<div class="description">
									<h5 class="text-secondary">Informasi dasar</h5><hr>
									<?php echo $error; ?>
									<?php echo $msg; ?>
										...
										<div class="row">
											...
											<div class="col-xl-6">
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Jenis Properti</label>
													<div class="col-lg-9">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Jenis Jual</label>
													<div class="col-lg-9">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Dapur</label>
													<div class="col-lg-9">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Balkon</label>
													<div class="col-lg-9">
										...
										<h5 class="text-secondary">Harga & Lokasi</h5><hr>
										<div class="row">
											<div class="col-xl-6">
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Lantai</label>
													<div class="col-lg-9">
											...
											<div class="col-xl-6">
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Total Lantai</label>
													<div class="col-lg-9">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Ukuran Wilayah</label>
													<div class="col-lg-9">
										...
										<div class="form-group row">
											<label class="col-lg-2 col-form-label">Fitur</label>
											<div class="col-lg-9">
											<p class="alert alert-danger">* Penting Harap Jangan Hapus Konten Di Bawah Hanya Ubah <b>Yes</b> Or <b>No</b> atau Detail dan Jangan Tambahkan Lebih Banyak Detail</p>
											
											<textarea class="tinymce form-control" name="feature" rows="10" cols="30">
												<!---feature area start--->
												<div class="col-md-4">
														<ul>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Usia Properti: </span>10 Years</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">KOlam renang : </span>Yes</li>
													...
													<div class="col-md-4">
														...
														<li class="mb-3"><span class="text-secondary font-weight-bold">Kapasitas Makan : </span>10 People</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Tempat Ibadah  : </span>No</li>
														
														</ul>
													</div>
													<div class="col-md-4">
														<ul>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Pihak ke-3 : </span>No</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Eskalator : </span>Yes</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">CCTV : </span>Yes</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Persediaan air : </span>Ground Water / Tank</li>
														</ul>
													</div>
												<!---feature area end---->
											</textarea>
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Gambar Denah Lantai Basement</label>
													<div class="col-lg-9">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Gambar Denah Lantai</label>
													<div class="col-lg-9">
														<input class="form-control" name="fimage" type="file">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Gambar Denah Lantai Dasar</label>
													<div class="col-lg-9">
										...
										<div class="row"><!-- FOR MORE PROJECTS visit: codeastro.com -->
											<div class="col-md-6">
												<div class="form-group row">
													<label class="col-lg-3 col-form-label"><b>Diunggulkan?</b></label>
													<div class="col-lg-9">
