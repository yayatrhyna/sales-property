...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner/images2.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            <h1 class="mb-4"><span class="text-success">Biarkan kami</span><br>
                            Memandu Mencarikan Rumah</h1><!-- FOR MORE PROJECTS visit: codeastro.com -->
                            <foGuide you Homerm method="post" action="propertygrid.php">
                                <div class="row">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                        <h2 class="text-secondary double-down-line text-center mb-5">Apa yang Kami Lakukan</h2></div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Layanan Penjualan</a></h5>
                                <p>Ini adalah teks tiruan untuk mengisi spasi. Hanya beberapa kata acak</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-for-rent text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Layanan Penyewaan</a></h5>
                                <p>Ini adalah teks tiruan untuk mengisi spasi. Hanya beberapa kata acak.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Daftar Properti</a></h5>
                                <p>Ini adalah teks tiruan untuk mengisi spasi. Hanya beberapa kata acak.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Investasi Hukumt</a></h5>
                                <p>>Ini adalah teks tiruan untuk mengisi spasi. Hanya beberapa kata acak</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-secondary double-down-line text-center mb-4">Properti Terbaru</h2>
                    </div>
                    <!--- <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-6">
                        <div class="living-list pr-4">
                            <h3 class="pb-4 mb-3 text-white">Mengapa Memilih Kami</h3>
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-reward flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Nilai Tertinggi</h5>
										<p>ini adalah teks tiruan untuk mengisi spasi. Ini hanyalah teks tiruan untuk mengisi ruang kosong.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
                                ...
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										<h5 class="mb-3">Agen Berpengalaman</h5>
										<p>ini adalah teks tiruan untuk mengisi spasi. Ini hanyalah teks tiruan untuk mengisi ruang kosong.</p>
									</div>
                                </li>
                            </ul>
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">Cara Kerjanya</h2>
                        </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <h5 class="text-secondary mt-5 mb-4">Diskusi</h5>
                            <p>ini adalah teks tiruan untuk mengisi spasi. Ini hanyalah teks tiruan untuk mengisi ruang kosong.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <h5 class="text-secondary mt-5 mb-4">Tinjauan File</h5>
                            <p>ini adalah teks tiruan untuk mengisi spasi. Ini hanyalah teks tiruan untuk mengisi ruang kosong.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <h5 class="text-secondary mt-5 mb-4">Mendapatkan</h5>
                            <p>ini adalah teks tiruan untuk mengisi spasi. Ini hanyalah teks tiruan untuk mengisi ruang kosong.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">Properti Tersedia</div>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">Dijual Properti Tersedia</div>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">Sewa Properti Tersedia</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-man flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">Pengguna Terdaftar</div>
                            </div>
                        </div>
        ...
        <div class="full-row bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">Tempat Populers</h2></div>
                </div><!-- FOR MORE PROJECTS visit: codeastro.com -->
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/6.jpeg" alt="">
                        ...
                        <div class="col-md-6 col-lg-3 pb-1"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/8.jpg" alt="">
                                
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/9.jpg" alt="">
