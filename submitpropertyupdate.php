    ...
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
                    <div class="row">
						<div class="col-lg-12">
							<h2 class="text-secondary double-down-line text-center">Update Properti</h2>
                        </div>
					</div>
									...
									<h5 class="text-secondary">Informasi dasar</h5><hr>
										<div class="row">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="ptype">
															...
															<option value="house">PErumanahan</option>
											...
											<div class="col-xl-6"><!-- FOR MORE PROJECTS visit: codeastro.com -->
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Tempat tidur</label>
													<div class="col-lg-9">
