                	...
                	<div class="loginbox">
                        <div class="login-right">
							<div class="login-right-wrap">
								<h1>Register</h1>
								<p class="account-subtitle">Akses ke dasbor kami</p>
								...
								<form method="post" enctype="multipart/form-data">
									...
									<div class="form-check-inline">
									  <label class="form-check-label">
										<input type="radio" class="form-check-input" name="utype" value="agent">Agen
									  </label>
									</div>
									<div class="form-check-inline disabled">
									  <label class="form-check-label">
										<input type="radio" class="form-check-input" name="utype" value="builder">Pembangun
									  </label>
									</div> 
									
									<div class="form-group">
										<label class="col-form-label"><b>Foto Pengguna</b></label>
								...
								<div class="text-center dont-have">Sudah memiliki akun? <a href="login.php">Login</a></div>
